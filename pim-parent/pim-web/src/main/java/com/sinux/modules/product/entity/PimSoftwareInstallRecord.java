 ...
 * @version 2018-07-30
 */
public class PimSoftwareInstallRecord extends DataEntity<PimSoftwareInstallRecord> {
	 ...
	 * 对象本身列
	 */
	private List<PimSoftwareInstallRecord> pimSoftwareInstallRecordList;
	
	public PimSoftwareInstallRecord() {
		super();
	}

	public PimSoftwareInstallRecord(String id){
		super(id);
	}
	...
	public List<PimSoftwareInstallRecord> getPimSoftwareInstallRecordList(){
		return pimSoftwareInstallRecordList;
	}
	
	public void setPimSoftwareInstallRecordList(List<PimSoftwareInstallRecord> pimSoftwareInstallRecordList){
		this.pimSoftwareInstallRecordList = pimSoftwareInstallRecordList;
	}
}